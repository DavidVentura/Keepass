    ...
    Flickable {
        ...
        Column {
            ...
            SettingsItem {
                ...
                description: i18n.ctr("description for tap to reveal passwort setting","Download page icons on database open")
                control: UITK.Switch {
            ...
            SettingsItem {
                ...
                description: i18n.ctr("description for auto-close setting","In minutes. 0 for disabled. Doesn\'t really work yet.")
